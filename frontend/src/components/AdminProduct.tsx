...
export default function AdminProduct({id, name, description, price, ingredients, weight, onChangeCallback }: IAdminProduct) {
  ...
  async function onDeleteProduct(e: any, productId: string) {
    e.preventDefault();
